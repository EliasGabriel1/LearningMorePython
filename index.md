...
Explicando de maneira simples como pandas funciona, cito coisas sobre no notbook que tem aqui no github clique <a href="https://github.com/EliasGabriel1/LearningMorePython/blob/main/BasicoPandas.ipynb"> aqui </a> para lógica e primeiros passos de lógica no pandas, e <a href="https://github.com/EliasGabriel1/LearningMorePython/blob/main/B%C3%A1sicoPandas2.ipynb">  aqui</a>, com o uso do pandas com mais funções, ja usando dados de uma df de 6422 rows, e <a href=""> aqui</a> eu concluo todas funções básicas do pandas.
